...
if __name__ == "__main__":
    ...
    print("\n## Conan:\n")
    print("\n### Remotes:\n")
    conan_remotes = subprocess.check_output(
        ["conan", "remote", "list"], universal_newlines=True, encoding="utf-8"
    ).strip()
    print(conan_remotes)
    print("\n### Profile Default:\n")
    conan_profile = subprocess.check_output(
        ["conan", "profile", "show"], universal_newlines=True, encoding="utf-8"
    ).strip()
    print(conan_profile)
